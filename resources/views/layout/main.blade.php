...
>
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" type="image/x-icon" href="{{ asset('sneat/img/logo.png') }}"/>
        ...
        <link
            ...
            rel="stylesheet"
        />
        <link rel="stylesheet" href="{{asset('sneat/vendor/libs/fontawesome/css/all.min.css')}}"/>
        ...
        <link rel="stylesheet" href="{{asset('sneat/css/custom.css')}}"/>
