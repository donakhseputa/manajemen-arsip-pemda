...
@section('content')
    ...
    <div class="nav-align-top">
        <ul class="nav nav-pills mb-4">
            ...
            <li class="nav-item">
                <a href="{{ route('agenda.incoming.archived') }}" class="nav-link active">
    ...
    @if(!$hasSelectedYear)
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <div>
                    <h5 class="mb-1">Folder Arsip Surat Masuk</h5>
                    <small class="text-muted">Pilih tahun untuk melihat isi arsip surat masuk.</small>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('agenda.incoming.archived') }}" method="GET" class="mb-4">
                    <div class="row g-3 align-items-end">
                        <div class="col-xl-4 col-lg-4 col-md-12">
                            <label for="search_folder_incoming" class="form-label mb-1 text-uppercase">Pencarian</label>
                            <input type="text" class="form-control" id="search_folder_incoming" name="search"
                                   value="{{ $search ?? '' }}"
                                   placeholder="Cari nomor agenda, nomor surat, atau pengirim">
                        </div>
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <label for="start_year_folder_incoming" class="form-label mb-1 text-uppercase">Tahun Awal</label>
                            <select class="form-select" id="start_year_folder_incoming" name="start_year">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <label for="end_year_folder_incoming" class="form-label mb-1 text-uppercase">Tahun Akhir</label>
                            <select class="form-select" id="end_year_folder_incoming" name="end_year">
                                <option value="">Pilih Tahun</option>
                                @foreach($archiveYearOptions as $year)
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a href="{{ route('agenda.incoming.archived') }}" class="btn btn-secondary">
                                    Reset
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row g-3">
                        @foreach($archiveYears as $folder)
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <a href="{{ route('agenda.incoming.archived', ['year' => $folder->archive_year]) }}"
                                    ...
                                    <div class="card border h-100 shadow-sm">
                                        <div class="card-body d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">{{ $folder->total }} surat masuk</small>
                                            </div>
                                        </div>
                                    </div>
                                </a>
            ...
            <div class="card-header border-bottom">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                    <div>
                        ...
                        <small class="text-muted">Daftar arsip surat masuk pada tahun {{ $selectedYear }}.</small>
                    </div>
                    <a href="{{ route('agenda.incoming.archived') }}" class="btn btn-sm btn-secondary">
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            ...
                            <select class="form-select" id="filter" name="filter">
                                <option value="received_date" @selected($filter === 'received_date')>Tanggal Diterima</option>
                    ...
                    @forelse($data as $agenda)
                        <tr>
                            <td>
                                ...
                                <a href="{{ route('agenda.incoming.archived.show', $agenda->id) }}" class="fw-semibold">
                                    {{ $agenda->agenda_number }}
                                </a>
                            </td>
                            <td>
                                <a href="{{ route('agenda.incoming.archived.show', $agenda->id) }}">{{ $agenda->reference_number }}</a>
                            </td>
                            <td>{{ $agenda->from }}</td>
