            ...
            <div class="card-body row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-text">
                            /
                            <span id="month-roman">V</span>
                            /
                            <span id="year-number">2026</span>
                        </span>
                    </div>
...
@push('script')
    ...
    <script>
        globalThis.outgoingLetterCreateJS = (function ($) {
            "use strict";
        ...
        globalThis.jQuery(function () {
            globalThis.outgoingLetterCreateJS.initModule(
                globalThis.outgoingLetterCreateJS
            );
        });
    </script>
@endpush
