...
@section('content')
    ...
    <div class="nav-align-top">
        <ul class="nav nav-pills mb-4">
            ...
            <li class="nav-item">
                <a href="{{ route('agenda.outgoing.archived') }}" class="nav-link">
...
@push('script')
    <script>
        globalThis.AgendaOutgoingJS = (function ($) {
            "use strict";
            ...
            var pub = {
                ...
                init: function () {
                    console.log("Agenda Outgoing JS Initialized");
        ...
        $(document).ready(function () {
            AgendaOutgoingJS.initModule(AgendaOutgoingJS);
        });
    </script>
@endpush